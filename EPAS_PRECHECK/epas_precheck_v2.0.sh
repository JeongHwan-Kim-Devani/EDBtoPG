...
<div class="hero"><h1>EPAS PostgreSQL &#49324;&#51204; &#51652;&#45800; &#47532;&#54252;&#53944;</h1><p>DB &#51060;&#47492;: <strong>${DBNAME}</strong></p></div>
<div class="card">
...
function renderImpact(){const d=dataset[state.selectedType];const i=d.impact;const c=i.critical;const w=i.warning;const s=i.safe;const n=i.none;if((c+w+s+n)<=0){donut.style.background='conic-gradient(#e2e8f0 0% 100%)';}else{donut.style.background='conic-gradient(var(--critical) 0% '+c+'%,var(--warning) '+c+'% '+(c+w)+'%,var(--safe) '+(c+w)+'% '+(c+w+s)+'%,var(--none) '+(c+w+s)+'% 100%)';}impactTotal.textContent=String(d.impacted);legendRoot.innerHTML=[legendItem('var(--critical)','&#44256;&#50689;&#54693;&#46020;',c),legendItem('var(--warning)','&#51473;&#50689;&#54693;&#46020;',w),legendItem('var(--safe)','&#51200;&#50689;&#54693;&#46020;',s),legendItem('var(--none)','&#50689;&#54693;&#50630;&#51020;',n)].join("");}
function bindPopupLinks(){const popupName="epas_report_popup";const popupFeatures="width=1280,height=900,resizable=yes,scrollbars=yes";function isHtmlLink(a){const h=(a.getAttribute("href")||"").trim().toLowerCase();if(!h||h.startsWith("#")||h.startsWith("javascript:"))return false;return h.endsWith(".html")||h.includes(".html?")||h.includes(".html#");}document.addEventListener("click",(e)=>{const a=e.target.closest("a[href]");if(!a||a.dataset.popup==="off")return;if(e.defaultPrevented||e.button!==0||e.metaKey||e.ctrlKey||e.shiftKey||e.altKey)return;if(!isHtmlLink(a))return;e.preventDefault();window.open(a.href,popupName,popupFeatures);});}
